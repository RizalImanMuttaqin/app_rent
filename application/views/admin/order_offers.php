              ...
              <table id="example" class="table table-bordered">
                ...
                <tbody>
                  <?php foreach ($orders as $key => $value) : ?>
                    <tr>
                      <form method="POST" action="<?= base_url('admin/transaction/update_offers/'. $value->id_order); ?>">
                      <td>
                        <p><?= $value->name ?></p>
                        <!-- <p><?= $value->phone ?></p> -->
                      ...
                      <td>
                        <div class="col-md-12" style="overflow: scroll;">
                              ...
                              <div class="card-header ml-0 headingOne">
                                <div class="row">
                                  <div class="col-md-3">
                                    ...
                                    <button type="button" class="btn btn-link btn-sm" data-toggle="collapse" data-target="#collapseOne<?= $value->id_order ?>" aria-expanded="true" aria-controls="#collapseOne<?= $value->id_order ?>">
                                  ...
                                  <div class="col-md-4">
                                    <ul class="list-unstyled">
                                      ...
                                      <li>
                                        ...
                                        <input style="float: right; color: red; text-align: right;" id="discount_order" class="inputNumbers" readonly value="200000"> -->
                                      </li>
                                      <li><span style="padding-right: 10%;">Total Ammount (Rp)</span> <b style="float: right; color: green;" class="formatNumbers"><?= ($value->total_harga) ?></b></li>
                                    </ul>
                                  </div>
                                </div>
                              </div>
                                  ...
                                  <?php
                                    ...
                                    foreach ($products as $product) :
                                      ...
                                      <tr>
                                        ...
                                        <td style="width: 15%;">
                                          <input type="text" readonly value="<?= $product->qty ?>" class="form-control" style="height: 30px; width: 60px; flex: none; text-align: center;">
                                        </td>
                                        <td style="width: 20%;">
                          ...
                          <td>
                            ...
                            <button type="submit" class="btn btn-sm btn-info col-md-12">Submit Offers</button>
                            <!-- <br><br> -->
